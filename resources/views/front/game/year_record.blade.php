                    ...
                    @for($day = 1; $day <= $maxDays; $day++)
                        <tr>
                            ...
                            @foreach($months as $monthNumber => $monthName)
                                ...
                                <td class="{{ $isInvalid ? 'invalid-cell' : ($display !== '-' ? 'has-result' : '') }}">
                                    {{ $display }}
                                </td>
                            @endforeach
                        </tr>
...
<style>
    ...
    /* Invalid date cells (e.g. Feb 30) - greyed out */
    .year-record-table td.invalid-cell {
        background-color: #f0f0f0;
        color: #ccc;
    }

    /* Declared result cells */
    .year-record-table td.has-result {
        color: #0618ff;
    }
